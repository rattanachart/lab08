<?php
$link = mysql_connect('localhost', 'it58160024', 'it58160024');
mysql_query("SET NAMES UTF8");
mysql_select_db('it58160024', $link);
...
$html1 = "";
$html2="";
$html3="<script>$(\"input\").change(function() {";
while($obj = mysql_fetch_object($result)){
    if($obj->status == 0){
    ...
    $html3 .= "if($('#".$obj->id."').prop(\"checked\") == true){
              \$.ajax({url: \"add_new_todo.php\", type: \"POST\", data: \"id=\" + ".$obj->id.", success: function(data) { $(\"#disp\").html(data); }, error: function(data) { $(\"#disp\").html(\"<h3>Error!</h3>\"); }});}";
}
